...
export function Home(){
  ...
  return(
    <main className="flex flex-col gap-2">
      <motion.p initial={{opacity: 0, h: "0%"}} animate={{opacity: 1, h: "100%"}} transition={{ duration: 1.5 }} className="text-gradient font-bold text-3xl">Hey there <span className="text-white">😉</span></motion.p>
