...
export function Home(){
  ...
  return(
    <main className="flex flex-col gap-2">
      ...
      <motion.h1 initial={{x: -100}} animate={{x: 0}}  className="text-4xl font-bold font-mono animate-bounce">My name's <span className="text-gradient animate-pulse">Daniel</span></motion.h1>
