...
export function About() {
  return (
    <main className="max-h-[80vh] overflow-y-scroll scrollbar flex flex-col gap-2">
      ...
      <motion.p initial={{opacity: 0, y: 100}} animate={{opacity: 1, y: 0}} transition={{ delay: 0.3 }} className="text-muted-foreground text-md">I intend to deepen my knowledge of web development both frontend and backend transitioning through tech stacks like Angular, GraphQL, PostgresSQL and more. Making sure to strengthen my expertise in DSA using javascript. I also plan to take a quick beginner graps of app development using flutter and AI and ML using python</motion.p>
    </main>
  )
}